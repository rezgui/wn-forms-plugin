...
class Permissions
{
    ...
    public static function lists(): array
    {
        return [
            self::EDIT_FORMS         => [
                'tab'   => __('gromit.forms::lang.permissions.tab'),
                'label' => __('gromit.forms::lang.permissions.edit_forms'),
            ],
            self::SHOW_SUBMISSIONS   => [
                'tab'   => __('gromit.forms::lang.permissions.tab'),
                'label' => __('gromit.forms::lang.permissions.show_submissions'),
            ],
            self::EXPORT_SUBMISSIONS => [
                'tab'   => __('gromit.forms::lang.permissions.tab'),
                'label' => __('gromit.forms::lang.permissions.export_submissions'),
            ],
            self::DELETE_SUBMISSIONS => [
                'tab'   => __('gromit.forms::lang.permissions.tab'),
                'label' => __('gromit.forms::lang.permissions.delete_submissions'),
            ],
            self::EDIT_SETTINGS      => [
                'tab'   => __('gromit.forms::lang.permissions.tab'),
                'label' => __('gromit.forms::lang.permissions.edit_settings'),
            ],
        ];
    }
}
