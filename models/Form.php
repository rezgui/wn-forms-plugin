...
class Form extends Model
{
    ...
    public function filterFields($fields, ?string $context = null): void
    {
        if ($context === 'update') {
            if ($fields->mail_template) {
                ...
                $fields->mail_template->comment = Lang::get('gromit.forms::lang.models.form.fields.mail_template.comment', [
    ...
    protected function beforeValidate(): void
    {
        $this->customMessages = [
            ...
            'extra_emails.*.email.required' => __('gromit.forms::lang.models.form.validation.extra_emails.email.required'),
